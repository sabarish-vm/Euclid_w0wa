...
pathlist = ['../results/montepython_mcmc/w0wa_spec_opt/2022-09-09_100000_' ]
mcmc1 = mcmc(pathlist=pathlist)


## Fishers
# Fisher CF
cf1 = Fisher('../results/cosmicfish_internal/spectroscopic/optimistic/CosmicFish_v0.9_w0wa_internal_class-Optimistic-own_GCsp_fishermatrix.txt')

# Fisher MP
mp1 = Fisher('../results/montepython_fisher/spectroscopic/optimistic_HP/fisher.mat')
