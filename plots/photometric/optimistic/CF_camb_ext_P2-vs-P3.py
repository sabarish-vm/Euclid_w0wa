...
fish_files =  [
    '../../../results/cosmicfish_external/photometric/optimistic/CosmicFish_v0.9_w0wa_external_camb-Optimistic-3PT_P2_WLGCph_fishermatrix.txt',
...
labels=  [r'CF_ext_camb XCph opt P2',
          r'CF_ext_camb Xcph opt P3']
