...
compare_errors_dict={'ncol_legend':4, 'legend_title':'GCsp opt', 'xticksrotation':45, 'yrang':[-10,10],
 'dots_legend_fontsize' : 30} #'transform_latex_dict': transf_labels}# 'legend_title_fontsize':16}
