...
fish_files =  [
    ...
    '../../../results/cosmicfish_external/spectroscopic/optimistic/CosmicFish_v0.9_w0wa_external_camb-Optimistic-own_HP_GCsp_fishermatrix.txt'
              ]
    
labels=  [r'CF_int_class GCsp opt',
          r'CF_ext_camb GCsp opt']

cutnames=['Omegam', 'Omegab','ns', 'h','sigma8','lnbgs8_1', 'lnbgs8_2', 'lnbgs8_3', 'lnbgs8_4', 'Ps_1', 'Ps_2', 'Ps_3', 'Ps_4']
