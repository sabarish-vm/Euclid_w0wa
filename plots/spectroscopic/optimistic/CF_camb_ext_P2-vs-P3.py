...
fish_files =  [
    '../../../results/cosmicfish_external/spectroscopic/optimistic/CosmicFish_v0.9_w0wa_external_camb-Optimistic-own_P2_GCsp_fishermatrix.txt',
...
labels=  [r'CF_ext_camb GCsp opt P2',
          r'CF_ext_camb GCsp opt P3']
