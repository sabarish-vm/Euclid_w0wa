...
fish_files =  [
    '../../../results/cosmicfish_external/spectroscopic/optimistic/CosmicFish_v0.9_w0wa_external_class-Optimistic-own_DP_GCsp_fishermatrix.txt',
...
labels=  [r'CF_ext_class GCsp opt DP',
          r'CF_ext_class GCsp opt HP']
