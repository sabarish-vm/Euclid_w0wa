...
axs[0,0].set_title(r'$P_\mathrm{L}(k,z=0)$')
...
axs[0,1].set_title(r'$P_\mathrm{NL}(k,z=0)$')
...
axs[1,0].set_title(r'$P_\mathrm{L}(k,z=2)$')
...
axs[1,1].set_title(r'$P_\mathrm{NL}(k,z=2)$')
